# refer to : https://github.com/jhagege/BoundedPriorityQueue/blob/master/bounded_priority_queue.py
...
# DISTANCE_INDEX = 1
DISTANCE_INDEX = 0 # index is zero due to the definition of KdNode.point in kdtree.py
...
class BoundedPriorityQueue:
    ...
    def propagate_up(self, index):
        ...
        print(f'self.heap[{self.parent(index)}][{DISTANCE_INDEX}]={self.heap[self.parent(index)][DISTANCE_INDEX]}, self.heap[{index}][{DISTANCE_INDEX}]={self.heap[index][DISTANCE_INDEX]}')
    ...
    def add(self, obj):
        ...
        if size == self.k:
            ...
            print(f'obj[{DISTANCE_INDEX}]:{obj[DISTANCE_INDEX]}, max_elem:{max_elem}')
    ...
    def max(self):
        ...
        # return self.heap[0][1] here is a bug, the second index should use DISTANCE_INDEX
        return self.heap[0][DISTANCE_INDEX]
